...
| `Errors` | [`List<M404ErrorResponseError>`](../../doc/models/m404-error-response-error.md) | Optional | - | List<M404ErrorResponseError> getErrors() | setErrors(List<M404ErrorResponseError> errors) |
