...
/**
 * This is a model class for M500ErrorResponseError type.
 */
public class M500ErrorResponseError {
    private String code;
    ...
    protected M500ErrorResponseError(String code, String title, String detail,
    ...
    /**
     * Converts this M500ErrorResponseError into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "M500ErrorResponseError [" + "code=" + code + ", title=" + title + ", detail="
                + detail + ", additionalInfo=" + additionalInfo + "]";
    }

    /**
     * Builds a new {@link M500ErrorResponseError.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link M500ErrorResponseError.Builder} object
     */
    ...
    /**
     * Class to build instances of {@link M500ErrorResponseError}.
     */
    public static class Builder {
        ...
        /**
         * Builds a new {@link M500ErrorResponseError} object using the set fields.
         * @return {@link M500ErrorResponseError}
         */
        public M500ErrorResponseError build() {
            return new M500ErrorResponseError(code, title, detail, additionalInfo);
        }
    }
}
