...
/**
 * This is a model class for M400ErrorResponseError type.
 */
public class M400ErrorResponseError {
    private String code;
    ...
    protected M400ErrorResponseError(String code, String title, String detail,
    ...
    /**
     * Converts this M400ErrorResponseError into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "M400ErrorResponseError [" + "code=" + code + ", title=" + title + ", detail="
                + detail + ", additionalInfo=" + additionalInfo + "]";
    }

    /**
     * Builds a new {@link M400ErrorResponseError.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link M400ErrorResponseError.Builder} object
     */
    ...
    /**
     * Class to build instances of {@link M400ErrorResponseError}.
     */
    public static class Builder {
        ...
        /**
         * Builds a new {@link M400ErrorResponseError} object using the set fields.
         * @return {@link M400ErrorResponseError}
         */
        public M400ErrorResponseError build() {
            return new M400ErrorResponseError(code, title, detail, additionalInfo);
        }
    }
}
