...
/**
 * This is a model class for M429ErrorResponseError type.
 */
public class M429ErrorResponseError {
    private String code;
    ...
    protected M429ErrorResponseError(String code, String title, String detail,
    ...
    /**
     * Converts this M429ErrorResponseError into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "M429ErrorResponseError [" + "code=" + code + ", title=" + title + ", detail="
                + detail + ", additionalInfo=" + additionalInfo + "]";
    }

    /**
     * Builds a new {@link M429ErrorResponseError.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link M429ErrorResponseError.Builder} object
     */
    ...
    /**
     * Class to build instances of {@link M429ErrorResponseError}.
     */
    public static class Builder {
        ...
        /**
         * Builds a new {@link M429ErrorResponseError} object using the set fields.
         * @return {@link M429ErrorResponseError}
         */
        public M429ErrorResponseError build() {
            return new M429ErrorResponseError(code, title, detail, additionalInfo);
        }
    }
}
