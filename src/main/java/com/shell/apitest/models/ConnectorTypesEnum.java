...
public enum ConnectorTypesEnum {
    ...
    private static TreeMap<String, ConnectorTypesEnum> valueMap = new TreeMap<>();
     ...
     */
    @JsonCreator
    public static ConnectorTypesEnum constructFromString(String toConvert) throws IOException {
        ConnectorTypesEnum enumValue = fromString(toConvert);
        if (enumValue == null) {
     ...
     * @return The enum member against the given string value.
     */
    public static ConnectorTypesEnum fromString(String toConvert) {
    ...
    /**
     * Convert list of ConnectorTypesEnum values to list of string values.
     * @param toConvert The list of ConnectorTypesEnum values to convert.
     * @return List of representative string values.
     */
    public static List<String> toValue(List<ConnectorTypesEnum> toConvert) {
        if (toConvert == null) {
            return null;
        }
        List<String> convertedValues = new ArrayList<>();
        for (ConnectorTypesEnum enumValue : toConvert) {
