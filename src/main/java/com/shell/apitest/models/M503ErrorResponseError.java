...
/**
 * This is a model class for M503ErrorResponseError type.
 */
public class M503ErrorResponseError {
    ...
    protected M503ErrorResponseError(String code, String title, String detail,
    ...
    /**
     * Converts this M503ErrorResponseError into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "M503ErrorResponseError [" + "code=" + code + ", title=" + title + ", detail="
                + detail + ", additionalInfo=" + additionalInfo + "]";
    }

    /**
     * Builds a new {@link M503ErrorResponseError.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link M503ErrorResponseError.Builder} object
     */
    ...
    /**
     * Class to build instances of {@link M503ErrorResponseError}.
     */
    public static class Builder {
        ...
        /**
         * Builds a new {@link M503ErrorResponseError} object using the set fields.
         * @return {@link M503ErrorResponseError}
         */
        public M503ErrorResponseError build() {
            return new M503ErrorResponseError(code, title, detail, additionalInfo);
        }
    }
}
