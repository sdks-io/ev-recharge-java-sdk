...
/**
 * This is a model class for M401ErrorResponseError type.
 */
public class M401ErrorResponseError {
    private String code;
    ...
    protected M401ErrorResponseError(String code, String title, String detail,
    ...
    /**
     * Converts this M401ErrorResponseError into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "M401ErrorResponseError [" + "code=" + code + ", title=" + title + ", detail="
                + detail + ", additionalInfo=" + additionalInfo + "]";
    }

    /**
     * Builds a new {@link M401ErrorResponseError.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link M401ErrorResponseError.Builder} object
     */
    ...
    /**
     * Class to build instances of {@link M401ErrorResponseError}.
     */
    public static class Builder {
        ...
        /**
         * Builds a new {@link M401ErrorResponseError} object using the set fields.
         * @return {@link M401ErrorResponseError}
         */
        public M401ErrorResponseError build() {
            return new M401ErrorResponseError(code, title, detail, additionalInfo);
        }
    }
}
