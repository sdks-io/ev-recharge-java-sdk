...
/**
 * GetLocationsListConnectorTypesEnum to be used.
 */
public enum GetLocationsListConnectorTypesEnum {
    AVCON,
    ...
    private static TreeMap<String, GetLocationsListConnectorTypesEnum> valueMap = new TreeMap<>();
     ...
     */
    @JsonCreator
    public static GetLocationsListConnectorTypesEnum constructFromString(String toConvert) throws IOException {
        GetLocationsListConnectorTypesEnum enumValue = fromString(toConvert);
        if (enumValue == null) {
     ...
     * @return The enum member against the given string value.
     */
    public static GetLocationsListConnectorTypesEnum fromString(String toConvert) {
    ...
    /**
     * Convert list of GetLocationsListConnectorTypesEnum values to list of string values.
     * @param toConvert The list of GetLocationsListConnectorTypesEnum values to convert.
     * @return List of representative string values.
     */
    public static List<String> toValue(List<GetLocationsListConnectorTypesEnum> toConvert) {
        if (toConvert == null) {
            return null;
        }
        List<String> convertedValues = new ArrayList<>();
        for (GetLocationsListConnectorTypesEnum enumValue : toConvert) {
