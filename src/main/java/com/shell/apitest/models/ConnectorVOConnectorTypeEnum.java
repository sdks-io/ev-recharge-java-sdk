...
/**
 * ConnectorVOConnectorTypeEnum to be used.
 */
public enum ConnectorVOConnectorTypeEnum {
    AVCON,
    ...
    private static TreeMap<String, ConnectorVOConnectorTypeEnum> valueMap = new TreeMap<>();
     ...
     */
    @JsonCreator
    public static ConnectorVOConnectorTypeEnum constructFromString(String toConvert) throws IOException {
        ConnectorVOConnectorTypeEnum enumValue = fromString(toConvert);
        if (enumValue == null) {
     ...
     * @return The enum member against the given string value.
     */
    public static ConnectorVOConnectorTypeEnum fromString(String toConvert) {
    ...
    /**
     * Convert list of ConnectorVOConnectorTypeEnum values to list of string values.
     * @param toConvert The list of ConnectorVOConnectorTypeEnum values to convert.
     * @return List of representative string values.
     */
    public static List<String> toValue(List<ConnectorVOConnectorTypeEnum> toConvert) {
        if (toConvert == null) {
            return null;
        }
        List<String> convertedValues = new ArrayList<>();
        for (ConnectorVOConnectorTypeEnum enumValue : toConvert) {
