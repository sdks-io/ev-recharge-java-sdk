 ...
 */
@JsonDeserialize(using = MarkersResponse.MarkersResponseDeserializer.class)
public abstract class MarkersResponse {
     ...
     */
    public static MarkersResponse fromSingleLocationMarker(
    ...
    /**
     * This is a custom deserializer class for MarkersResponse.
     */
    protected static class MarkersResponseDeserializer
            extends JsonDeserializer<MarkersResponse> {

        private String discriminator = "markerType";
        private List<Map<String, Class<? extends MarkersResponse>>> registry =
                Arrays.asList(
        ...
        @Override
        public MarkersResponse deserialize(JsonParser jp, DeserializationContext ctxt)
