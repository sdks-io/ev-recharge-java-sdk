...
/**
 * This is a model class for M405ErrorResponseError type.
 */
public class M405ErrorResponseError {
    private String code;
    ...
    protected M405ErrorResponseError(String code, String title, String detail,
    ...
    /**
     * Converts this M405ErrorResponseError into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "M405ErrorResponseError [" + "code=" + code + ", title=" + title + ", detail="
                + detail + ", additionalInfo=" + additionalInfo + "]";
    }

    /**
     * Builds a new {@link M405ErrorResponseError.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link M405ErrorResponseError.Builder} object
     */
    ...
    /**
     * Class to build instances of {@link M405ErrorResponseError}.
     */
    public static class Builder {
        ...
        /**
         * Builds a new {@link M405ErrorResponseError} object using the set fields.
         * @return {@link M405ErrorResponseError}
         */
        public M405ErrorResponseError build() {
            return new M405ErrorResponseError(code, title, detail, additionalInfo);
        }
    }
}
