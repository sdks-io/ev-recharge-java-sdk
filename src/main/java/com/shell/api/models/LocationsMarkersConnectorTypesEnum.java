...
/**
 * LocationsMarkersConnectorTypesEnum to be used.
 */
public enum LocationsMarkersConnectorTypesEnum {
    ...
    private static TreeMap<String, LocationsMarkersConnectorTypesEnum> valueMap = new TreeMap<>();
     ...
     */
    @JsonCreator
    public static LocationsMarkersConnectorTypesEnum constructFromString(String toConvert) throws IOException {
        LocationsMarkersConnectorTypesEnum enumValue = fromString(toConvert);
        if (enumValue == null) {
     ...
     * @return The enum member against the given string value.
     */
    public static LocationsMarkersConnectorTypesEnum fromString(String toConvert) {
    ...
    /**
     * Convert list of LocationsMarkersConnectorTypesEnum values to list of string values.
     * @param toConvert The list of LocationsMarkersConnectorTypesEnum values to convert.
     * @return List of representative string values.
     */
    public static List<String> toValue(List<LocationsMarkersConnectorTypesEnum> toConvert) {
        if (toConvert == null) {
            return null;
        }
        List<String> convertedValues = new ArrayList<>();
        for (LocationsMarkersConnectorTypesEnum enumValue : toConvert) {
