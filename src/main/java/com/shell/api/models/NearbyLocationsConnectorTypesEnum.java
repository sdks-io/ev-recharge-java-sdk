...
/**
 * NearbyLocationsConnectorTypesEnum to be used.
 */
public enum NearbyLocationsConnectorTypesEnum {
    AVCON,
    ...
    private static TreeMap<String, NearbyLocationsConnectorTypesEnum> valueMap = new TreeMap<>();
     ...
     */
    @JsonCreator
    public static NearbyLocationsConnectorTypesEnum constructFromString(String toConvert) throws IOException {
        NearbyLocationsConnectorTypesEnum enumValue = fromString(toConvert);
        if (enumValue == null) {
     ...
     * @return The enum member against the given string value.
     */
    public static NearbyLocationsConnectorTypesEnum fromString(String toConvert) {
    ...
    /**
     * Convert list of NearbyLocationsConnectorTypesEnum values to list of string values.
     * @param toConvert The list of NearbyLocationsConnectorTypesEnum values to convert.
     * @return List of representative string values.
     */
    public static List<String> toValue(List<NearbyLocationsConnectorTypesEnum> toConvert) {
        if (toConvert == null) {
            return null;
        }
        List<String> convertedValues = new ArrayList<>();
        for (NearbyLocationsConnectorTypesEnum enumValue : toConvert) {
